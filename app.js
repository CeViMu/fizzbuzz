...
const rawdata = fs.readFileSync("explorers.json"); //Read the file and return the content
const explorers = JSON.parse(rawdata); //trasnform the text(rawdata) into json format
